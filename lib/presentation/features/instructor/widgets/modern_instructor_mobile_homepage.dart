...
/// Modern mobile-first homepage design for instructors
class ModernInstructorMobileHomepage extends ConsumerStatefulWidget {
  const ModernInstructorMobileHomepage({super.key});

  @override
  ConsumerState<ModernInstructorMobileHomepage> createState() =>
      _ModernInstructorMobileHomepageState();
}

class _ModernInstructorMobileHomepageState
    extends ConsumerState<ModernInstructorMobileHomepage> {
  ...
  Widget _buildTopHeader(String displayName, String? avatarUrl) {
    return Container(
  ...
  Widget _buildBannerCarousel() {
    final banners = [
      {
        'title': 'Welcome Back!',
        'subtitle': 'Manage your courses efficiently',
        'icon': Icons.waving_hand,
        'color': const Color(0xFF6366F1),
      },
      {
        'title': 'Pending Submissions',
        'subtitle': 'Review student assignments',
  ...
  List<QuickAccessItem> _getRecentlyUsedItems() {
    return [
      QuickAccessItem(Icons.dashboard_outlined, 'Dashboard', () {
        Navigator.push(
          context,
  ...
  List<QuickAccessItem> _getTeachingItems() {
    return [
  ...
  List<QuickAccessItem> _getManagementItems() {
    return [
      QuickAccessItem(Icons.dashboard_outlined, 'Dashboard', () {
        Navigator.push(
          context,
