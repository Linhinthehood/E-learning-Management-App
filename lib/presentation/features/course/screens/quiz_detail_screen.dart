...
class QuizDetailScreen extends ConsumerStatefulWidget {
  ...
  const QuizDetailScreen({super.key, required this.course, required this.quiz});
      ...
      if (mounted) {
        ...
        if (userId != null) {
          ref
              ...
              .loadStudentAttempts(widget.quiz.id, userId);
        }
      }
    });
  }
                  ...
                  data: (allAttempts) {
                    ...
                    final attempts =
                        allAttempts
                          ...
                          ..sort(
                            (a, b) =>
                                b.attemptNumber.compareTo(a.attemptNumber),
                          );
